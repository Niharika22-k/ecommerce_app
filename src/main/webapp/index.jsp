        ...
        <div id="visual">
            <div class="slide-visual">
                <ul class="slide-group">
                    <li><img class="img-responsive" src="images/img3.jpeg" alt="Dummy Image" /></li>
                    <li><img class="img-responsive" src="images/img4.jpeg" alt="Dummy Image" /></li>
                    <li><img class="img-responsive" src="images/img3.jpeg" alt="Dummy Image" /></li>
                    <li><img class="img-responsive" src="images/img4.jpeg" alt="Dummy Image" /></li>
                    <li><img class="img-responsive" src="images/img3.jpegg" alt="Dummy Image" /></li>
                </ul>
